...
pub enum State { Empty, Ready, Sleeping(u64), BlockedIpc, Exited }
...
impl State {
    ...
    pub fn label(self) -> &'static str {
        match self { Self::Empty => "EMPTY", Self::Ready => "READY", Self::Sleeping(_) => "SLEEPING", Self::BlockedIpc => "IPC_WAIT", Self::Exited => "EXITED" }
    }
}
